...
public class DecryptRuntimeFieldType extends DecryptFieldType {
    ...
    protected static class Builder extends CryptographyRuntimeField.Builder {
        ...
        protected RuntimeField createRuntimeField(MappingParserContext parserContext) {
            final MappedFieldType ft = new DecryptRuntimeFieldType(name, meta(), key.get(), cipher.get());
            return new LeafRuntimeField(name, ft, getParameters());
        }
    }

    public DecryptRuntimeFieldType(String name, Map<String, String> meta, String key, CipherType cipher) {
